...
from .fs5Model import PARTICLE_FLAG_ACTIVE, ModelShapeMaterials, ModelShapeGeometry
...
def eval_body_joints(
    ...
    if type == fs5Model.JOINT_PRISMATIC:
    ...
    if type == fs5Model.JOINT_COMPOUND:
    ...
    if type == fs5Model.JOINT_UNIVERSAL:
        q_pc = wp.quat_inverse(q_p) * q_c
