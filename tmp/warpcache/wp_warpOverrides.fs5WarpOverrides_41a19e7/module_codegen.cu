...
extern "C" __global__ void increaseRadius_cuda_kernel_forward(
    wp::launch_bounds_t dim,
    wp::array_t<wp::float32> var_particle_radius,
    wp::float32 var_dr,
    wp::float32 var_maxRad)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def increaseRadius(                                                                    <L 28>
        // tid = wp.tid()                                                                         <L 33>
        var_0 = builtin_tid1d();
        // radius = particle_radius[tid]                                                          <L 34>
        var_1 = wp::address(var_particle_radius, var_0);
        var_2 = wp::load(var_1);
        var_3 = wp::copy(var_2);
        // if radius<maxRad:                                                                      <L 35>
        var_4 = (var_3 < var_maxRad);
        if (var_4) {
            // deltaRad=radius*dr                                                                 <L 36>
            var_5 = wp::mul(var_3, var_dr);
            // particle_radius[tid]=particle_radius[tid]+deltaRad                                 <L 37>
            var_6 = wp::address(var_particle_radius, var_0);
            var_7 = wp::load(var_6);
            var_8 = wp::add(var_7, var_5);
            wp::array_store(var_particle_radius, var_0, var_8);
        }
    }
}

extern "C" __global__ void increaseRadius_cuda_kernel_backward(
    wp::launch_bounds_t dim,
    wp::array_t<wp::float32> var_particle_radius,
    wp::float32 var_dr,
    wp::float32 var_maxRad,
    ...
    wp::float32 adj_maxRad)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // reverse
        if (var_4) {
            wp::adj_array_store(var_particle_radius, var_0, var_8, adj_particle_radius, adj_0, adj_8);
            wp::adj_add(var_7, var_5, adj_6, adj_5, adj_8);
            wp::adj_load(var_6, adj_6, adj_7);
            wp::adj_address(var_particle_radius, var_0, adj_particle_radius, adj_0, adj_6);
            // adj: particle_radius[tid]=particle_radius[tid]+deltaRad                            <L 37>
            wp::adj_mul(var_3, var_dr, adj_3, adj_dr, adj_5);
            // adj: deltaRad=radius*dr                                                            <L 36>
        }
        // adj: if radius<maxRad:                                                                 <L 35>
        wp::adj_copy(var_2, adj_1, adj_3);
        wp::adj_load(var_1, adj_1, adj_2);
        wp::adj_address(var_particle_radius, var_0, adj_particle_radius, adj_0, adj_1);
        // adj: radius = particle_radius[tid]                                                     <L 34>
        // adj: tid = wp.tid()                                                                    <L 33>
        // adj: def increaseRadius(                                                               <L 28>
        continue;
    }
}
    ...
    wp::float32 var_dt)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def sleepParticles(                                                                    <L 40>
        // tid = wp.tid()                                                                         <L 48>
        var_0 = builtin_tid1d();
        // if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                                  <L 49>
        ...
        // if wp.length(particle_positions_after[tid]-particle_positions_init[tid])/dt<sleepThreshold:       <L 52>
        ...
        if (var_14) {
            // particle_positions_after[tid]=particle_positions_init[tid]                         <L 53>
    ...
    wp::float32 adj_dt)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        if (var_14) {
            ...
            // adj: particle_positions_after[tid]=particle_positions_init[tid]                    <L 53>
        }
        ...
        // adj: if wp.length(particle_positions_after[tid]-particle_positions_init[tid])/dt<sleepThreshold:  <L 52>
        if (var_6) {
            label0:;
            // adj: return                                                                        <L 50>
        }
        ...
        // adj: if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                             <L 49>
        // adj: tid = wp.tid()                                                                    <L 48>
        // adj: def sleepParticles(                                                               <L 40>
        continue;
    }
}
    ...
    wp::float32 var_swellingActivationLocationRatio)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        wp::uint32 var_95;
        wp::float32 var_96;
        const wp::float32 var_97 = 25.0;
        wp::float32 var_98;
        //---------
        // forward
        // def swellParticles(                                                                    <L 56>
        // tid = wp.tid()                                                                         <L 68>
        var_0 = builtin_tid1d();
        // i=wp.uint32(tid)                                                                       <L 69>
        var_1 = wp::uint32(var_0);
        // flag = particle_flags[tid]                                                             <L 70>
        var_2 = wp::address(var_particle_flags, var_0);
        var_3 = wp::load(var_2);
        var_4 = wp::copy(var_3);
        // position=particle_position[tid]                                                        <L 71>
        var_5 = wp::address(var_particle_position, var_0);
        var_6 = wp::load(var_5);
        var_7 = wp::copy(var_6);
        // y=position[1]                                                                          <L 72>
        var_9 = wp::extract(var_7, var_8);
        // if y>yShift and flag==wp.uint32(1): # if particle is active                            <L 73>
        var_10 = (var_9 > var_yShift);
        var_11 = wp::uint32(var_8);
        var_12 = (var_4 == var_11);
        var_13 = var_10 && var_12;
        if (var_13) {
            // trackedID=tid+1                                                                    <L 74>
            var_14 = wp::add(var_0, var_8);
            // if trackedID<particle_flags.shape[0]:                                              <L 75>
            var_16 = &(var_particle_flags.shape);
            var_17 = wp::load(var_16);
            var_18 = wp::extract(var_17, var_15);
            var_19 = (var_14 < var_18);
            if (var_19) {
                // if particle_flags[trackedID]==wp.uint32(0): # check if it has a swelling particle       <L 76>
                var_20 = wp::address(var_particle_flags, var_14);
                var_21 = wp::uint32(var_15);
                var_23 = wp::load(var_20);
                var_22 = (var_23 == var_21);
                if (var_22) {
                    // trackedPosition=particle_position[trackedID]                               <L 77>
                    var_24 = wp::address(var_particle_position, var_14);
                    var_25 = wp::load(var_24);
                    var_26 = wp::copy(var_25);
                    // trackedy=trackedPosition[1]                                                <L 78>
                    var_27 = wp::extract(var_26, var_8);
                    // dx=trackedPosition - position                                              <L 79>
                    var_28 = wp::sub(var_26, var_7);
                    // dist=wp.length(dx)                                                         <L 80>
                    var_29 = wp::length(var_28);
                    // if trackedy>yShift and dist>=swelling_activation_factor and wp.randf(i)<chance: # if the swelling particle is eligible, swell it       <L 81>
                    ...
                    if (var_34) {
                        ...
                        // newPosition[1]=(position[1]*(1.0-phii)+trackedPosition[1]*phii) + jitterY       <L 95>
                        ...
                        // newPosition[2]=(position[2]*(1.0-phii)+trackedPosition[2]*phii) + jitterZ       <L 96>
                        ...
                        // particle_flags[trackedID]=wp.uint32(1)                                 <L 98>
                        var_95 = wp::uint32(var_8);
                        wp::array_store(var_particle_flags, var_14, var_95);
                        // particle_position[trackedID]=newPosition                               <L 99>
                        wp::array_store(var_particle_position, var_14, var_41);
                        // particle_inv_mass[trackedID]=mass#*10000.0                             <L 100>
                        wp::array_store(var_particle_inv_mass, var_14, var_37);
                        // particle_radius[trackedID]=radius/swelling_rotation_max/25.0           <L 101>
                        var_96 = wp::div(var_40, var_swelling_rotation_max);
                        var_98 = wp::div(var_96, var_97);
                        wp::array_store(var_particle_radius, var_14, var_98);
                    }
                }
            }
        }
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        if (var_13) {
            if (var_19) {
                if (var_22) {
                    if (var_34) {
                        wp::adj_array_store(var_particle_radius, var_14, var_98, adj_particle_radius, adj_14, adj_98);
                        wp::adj_div(var_96, var_97, var_98, adj_96, adj_97, adj_98);
                        wp::adj_div(var_40, var_swelling_rotation_max, var_96, adj_40, adj_swelling_rotation_max, adj_96);
                        // adj: particle_radius[trackedID]=radius/swelling_rotation_max/25.0      <L 101>
                        wp::adj_array_store(var_particle_inv_mass, var_14, var_37, adj_particle_inv_mass, adj_14, adj_37);
                        // adj: particle_inv_mass[trackedID]=mass#*10000.0                        <L 100>
                        wp::adj_array_store(var_particle_position, var_14, var_41, adj_particle_position, adj_14, adj_41);
                        // adj: particle_position[trackedID]=newPosition                          <L 99>
                        wp::adj_array_store(var_particle_flags, var_14, var_95, adj_particle_flags, adj_14, adj_95);
                        wp::adj_uint32(var_8, adj_8, adj_95);
                        // adj: particle_flags[trackedID]=wp.uint32(1)                            <L 98>
                        ...
                        // adj: newPosition[2]=(position[2]*(1.0-phii)+trackedPosition[2]*phii) + jitterZ  <L 96>
                        ...
                        // adj: newPosition[1]=(position[1]*(1.0-phii)+trackedPosition[1]*phii) + jitterY  <L 95>
                        ...
                        // adj: jitterY = r * wp.sin(theta) * wp.sin(phi)                         <L 90>
                        ...
                        // adj: jitterX = r * wp.sin(theta) * wp.cos(phi)                         <L 89>
                        ...
                        // adj: phi = wp.randf(i+wp.uint32(3))*6.28                               <L 88>
                        ...
                        // adj: theta = wp.randf(i+wp.uint32(2))*3.14                             <L 87>
                        ...
                        // adj: r = wp.randf(i+wp.uint32(1))*radius*jitterFactor                  <L 86>
                        // adj: newPosition=wp.vec3()                                             <L 85>
                        ...
                        // adj: radius=particle_radius[tid]                                       <L 83>
                        ...
                        // adj: mass=particle_inv_mass[tid]                                       <L 82>
                    }
                    wp::adj_randf(var_1, adj_1, adj_32);
                    // adj: if trackedy>yShift and dist>=swelling_activation_factor and wp.randf(i)<chance: # if the swelling particle is eligible, swell it  <L 81>
                    wp::adj_length(var_28, var_29, adj_28, adj_29);
                    // adj: dist=wp.length(dx)                                                    <L 80>
                    wp::adj_sub(var_26, var_7, adj_26, adj_7, adj_28);
                    // adj: dx=trackedPosition - position                                         <L 79>
                    wp::adj_extract(var_26, var_8, adj_26, adj_8, adj_27);
                    // adj: trackedy=trackedPosition[1]                                           <L 78>
                    ...
                    // adj: trackedPosition=particle_position[trackedID]                          <L 77>
                }
                ...
                // adj: if particle_flags[trackedID]==wp.uint32(0): # check if it has a swelling particle  <L 76>
            }
            wp::adj_extract(var_17, var_15, adj_16, adj_15, adj_18);
            wp::adj_load(var_16, adj_16, adj_17);
            adj_particle_flags.shape = adj_16;
            // adj: if trackedID<particle_flags.shape[0]:                                         <L 75>
            wp::adj_add(var_0, var_8, adj_0, adj_8, adj_14);
            // adj: trackedID=tid+1                                                               <L 74>
        }
        wp::adj_uint32(var_8, adj_8, adj_11);
        // adj: if y>yShift and flag==wp.uint32(1): # if particle is active                       <L 73>
        wp::adj_extract(var_7, var_8, adj_7, adj_8, adj_9);
        // adj: y=position[1]                                                                     <L 72>
        ...
        // adj: position=particle_position[tid]                                                   <L 71>
        ...
        // adj: flag = particle_flags[tid]                                                        <L 70>
        wp::adj_uint32(var_0, adj_0, adj_1);
        // adj: i=wp.uint32(tid)                                                                  <L 69>
        // adj: tid = wp.tid()                                                                    <L 68>
        // adj: def swellParticles(                                                               <L 56>
        continue;
    }
}
    ...
    wp::float32 var_fullRadius)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def swellParticlesStage2(                                                              <L 105>
        // tid = wp.tid()                                                                         <L 113>
        var_0 = builtin_tid1d();
        // if particle_flags[tid]==wp.uint32(1) and particle_radius[tid]<fullRadius:              <L 114>
        var_1 = wp::address(var_particle_flags, var_0);
        ...
        var_9 = var_4 && var_7;
        if (var_9) {
            // particle_radius[tid]=particle_radius[tid]+fullRadius/swelling_rotation_max/25.0       <L 115>
    ...
    wp::float32 adj_fullRadius)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        if (var_9) {
            ...
            // adj: particle_radius[tid]=particle_radius[tid]+fullRadius/swelling_rotation_max/25.0  <L 115>
        }
        ...
        wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_1);
        // adj: if particle_flags[tid]==wp.uint32(1) and particle_radius[tid]<fullRadius:         <L 114>
        // adj: tid = wp.tid()                                                                    <L 113>
        // adj: def swellParticlesStage2(                                                         <L 105>
        continue;
    }
}
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> var_v_new)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_integrate_particles(                                                            <L 121>
        // tid = wp.tid()                                                                         <L 133>
        var_0 = builtin_tid1d();
        // if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                                  <L 134>
        var_1 = wp::address(var_particle_flags, var_0);
        var_3 = wp::load(var_1);
        var_4 = wp::bit_and(var_3, var_2);
        var_6 = (var_4 == var_5);
        ...
        // inv_mass = w[tid]                                                                      <L 139>
        var_16 = wp::address(var_w, var_0);
        var_17 = wp::load(var_16);
        var_18 = wp::copy(var_17);
        // v1 = v0 + (f0 * inv_mass + gravity * wp.step(0.0 - inv_mass)) * dt                     <L 140>
        ...
        // v1_mag = wp.length(v1)                                                                 <L 141>
        var_27 = wp::length(var_26);
        // if v1_mag > v_max:                                                                     <L 142>
        var_28 = (var_27 > var_v_max);
        if (var_28) {
            // v1 *= v_max / v1_mag                                                               <L 143>
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> adj_v_new)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        if (var_28) {
            ...
            // adj: v1 *= v_max / v1_mag                                                          <L 143>
        }
        // adj: if v1_mag > v_max:                                                                <L 142>
        wp::adj_length(var_26, var_27, adj_26, adj_27);
        // adj: v1_mag = wp.length(v1)                                                            <L 141>
        ...
        // adj: v1 = v0 + (f0 * inv_mass + gravity * wp.step(0.0 - inv_mass)) * dt                <L 140>
        wp::adj_copy(var_17, adj_16, adj_18);
        wp::adj_load(var_16, adj_16, adj_17);
        wp::adj_address(var_w, var_0, adj_w, adj_0, adj_16);
        // adj: inv_mass = w[tid]                                                                 <L 139>
        ...
        wp::adj_load(var_1, adj_1, adj_3);
        wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_1);
        // adj: if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                             <L 134>
        // adj: tid = wp.tid()                                                                    <L 133>
        // adj: def my_integrate_particles(                                                       <L 121>
        continue;
    }
}
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> var_v_out)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_apply_particle_deltas(                                                          <L 149>
        // tid = wp.tid()                                                                         <L 159>
        var_0 = builtin_tid1d();
        // if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                                  <L 160>
        var_1 = wp::address(var_particle_flags, var_0);
        var_3 = wp::load(var_1);
        var_4 = wp::bit_and(var_3, var_2);
        var_6 = (var_4 == var_5);
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> adj_v_out)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        wp::adj_load(var_1, adj_1, adj_3);
        wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_1);
        // adj: if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                             <L 160>
        // adj: tid = wp.tid()                                                                    <L 159>
        // adj: def my_apply_particle_deltas(                                                     <L 149>
        continue;
    }
}
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> var_delta)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_solve_particle_ground_contacts(                                                 <L 179>
        // tid = wp.tid()                                                                         <L 196>
        var_0 = builtin_tid1d();
        // if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                                  <L 197>
        var_1 = wp::address(var_particle_flags, var_0);
        var_3 = wp::load(var_1);
        var_4 = wp::bit_and(var_3, var_2);
        var_6 = (var_4 == var_5);
        ...
        // c = wp.min(wp.dot(n, x) + ground[3] - particle_radius[tid], 0.0)                       <L 206>
        ...
        // lambda_f = wp.max(mu * lambda_n, 0.0 - wp.length(vt) * dt)                             <L 215>
        ...
        // delta_f = wp.normalize(vt) * lambda_f                                                  <L 216>
        var_54 = wp::normalize(var_48);
        var_55 = wp::mul(var_54, var_53);
        // wp.atomic_add(delta, tid, (delta_f - delta_n) / wi * relaxation * wi)                  <L 217>
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> adj_delta)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // adj: wp.atomic_add(delta, tid, (delta_f - delta_n) / wi * relaxation * wi)             <L 217>
        wp::adj_mul(var_54, var_53, adj_54, adj_53, adj_55);
        wp::adj_normalize(var_48, var_54, adj_48, adj_54);
        // adj: delta_f = wp.normalize(vt) * lambda_f                                             <L 216>
        ...
        // adj: lambda_f = wp.max(mu * lambda_n, 0.0 - wp.length(vt) * dt)                        <L 215>
        ...
        if (var_44) {
            ...
            // adj: mu=staticGroundFriction                                                       <L 213>
        }
        wp::adj_abs(var_42, adj_42, adj_43);
        // adj: if wp.abs(vn)<staticGroundVelocityThresholdRatio:                                 <L 212>
        wp::adj_dot(var_29, var_20, adj_29, adj_20, adj_42);
        // adj: vn = wp.dot(n, v)                                                                 <L 211>
        wp::adj_mul(var_29, var_40, adj_29, adj_40, adj_41);
        // adj: delta_n = n * lambda_n                                                            <L 210>
        wp::adj_copy(var_38, adj_38, adj_40);
        // adj: lambda_n = c                                                                      <L 209>
        if (var_39) {
            label2:;
            // adj: return                                                                        <L 208>
        }
        ...
        // adj: c = wp.min(wp.dot(n, x) + ground[3] - particle_radius[tid], 0.0)                  <L 206>
        ...
        // adj: n = wp.vec3(ground[0], ground[1], ground[2])                                      <L 205>
        ...
        // adj: radius = particle_radius[tid]                                                     <L 202>
        if (var_11) {
            label1:;
            // adj: return                                                                        <L 201>
        }
        ...
        wp::adj_load(var_1, adj_1, adj_3);
        wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_1);
        // adj: if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                             <L 197>
        // adj: tid = wp.tid()                                                                    <L 196>
        // adj: def my_solve_particle_ground_contacts(                                            <L 179>
        continue;
    }
}
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> var_deltas)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_solve_particle_particle_contacts(                                               <L 220>
        // tid = wp.tid()                                                                         <L 236>
        var_0 = builtin_tid1d();
        // i = wp.hash_grid_point_id(grid, tid)                                                   <L 237>
        ...
        // if (particle_flags[i] & PARTICLE_FLAG_ACTIVE) == 0:                                    <L 240>
        ...
        if ((var_29) == false) goto end_while_2;
            ...
            if (var_35) {
                ...
                if (var_50) {
                    ...
                    // lambda_f = wp.max(k_mu * lambda_n, -wp.length(vt) * dt)                    <L 265>
                    ...
                    // delta_f = wp.normalize(vt) * lambda_f                                      <L 266>
                    var_69 = wp::normalize(var_63);
                    var_70 = wp::mul(var_69, var_68);
                    // delta += (delta_f - delta_n) / denom * w1                                  <L 267>
        ...
        goto start_while_2;
        end_while_2:;
        // wp.atomic_add(deltas, i, delta * relaxation)                                           <L 268>
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> adj_deltas)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // adj: wp.atomic_add(deltas, i, delta * relaxation)                                      <L 268>
        start_while_2:;
        var_29 = wp::hash_grid_query_next(var_25, var_26);
        if ((var_29) == false) goto end_while_2;
        adj_30 = {};
        ...
        adj_79 = {};
            ...
            if (var_35) {
                ...
                if (var_50) {
                    ...
                    // adj: lambda_f = wp.max(k_mu * lambda_n, -wp.length(vt) * dt)               <L 265>
                    ...
                    if (var_59) {
                        ...
                        // adj: k_mu=staticParticleFriction                                       <L 263>
                    }
                    wp::adj_abs(var_57, adj_57, adj_58);
                    // adj: if wp.abs(vn)<staticParticleVelocityThresholdRatio:                   <L 262>
                    wp::adj_dot(var_51, var_54, adj_51, adj_54, adj_57);
                    // adj: vn = wp.dot(n, vrel)                                                  <L 261>
                    wp::adj_mul(var_51, var_55, adj_51, adj_55, adj_56);
                    // adj: delta_n = n * lambda_n                                                <L 260>
                    wp::adj_copy(var_43, adj_43, adj_55);
                    // adj: lambda_n = err                                                        <L 259>
                    ...
                    // adj: vrel = v - particle_v[index]                                          <L 258>
                    wp::adj_div(var_38, var_39, adj_38, adj_39, adj_51);
                    // adj: n = n / d                                                             <L 257>
                }
                // adj: if err <= k_cohesion and denom > 0.0:                                     <L 256>
                wp::adj_add(var_22, var_46, adj_22, adj_46, adj_47);
                // adj: denom = w1 + w2                                                           <L 255>
                ...
                // adj: w2 = particle_invmass[index]                                              <L 254>
                ...
                // adj: err = d - radius - particle_radius[index]                                 <L 253>
                wp::adj_length(var_38, var_39, adj_38, adj_39);
                // adj: d = wp.length(n)                                                          <L 252>
                ...
                // adj: n = x - particle_x[index]                                                 <L 251>
            }
            ...
            // adj: if (particle_flags[index] & PARTICLE_FLAG_ACTIVE) != 0 and index != i:        <L 250>
        goto start_while_2;
        end_while_2:;
        // adj: while wp.hash_grid_query_next(query, index):                                      <L 249>
        wp::adj_vec_t(var_27, adj_27, adj_28);
        // adj: delta = wp.vec3(0.0)                                                              <L 248>
        wp::adj_int(var_9, adj_9, adj_26);
        // adj: index = int(0)                                                                    <L 247>
        ...
        // adj: query = wp.hash_grid_query(grid, x, radius + max_radius + k_cohesion)             <L 246>
        ...
        // adj: w1 = particle_invmass[i]                                                          <L 245>
        ...
        // adj: radius = particle_radius[i]                                                       <L 244>
        ...
        // adj: if (particle_flags[i] & PARTICLE_FLAG_ACTIVE) == 0:                               <L 240>
        if (var_4) {
            label0:;
            // adj: return                                                                        <L 239>
        }
        ...
        // adj: i = wp.hash_grid_point_id(grid, tid)                                              <L 237>
        // adj: tid = wp.tid()                                                                    <L 236>
        // adj: def my_solve_particle_particle_contacts(                                          <L 220>
        continue;
    }
}
    ...
    wp::array_t<wp::vec_t<6,wp::float32>> var_body_delta)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_solve_particle_shape_contacts(                                                  <L 271>
        // tid = wp.tid()                                                                         <L 300>
        var_0 = builtin_tid1d();
        // count = min(contact_max, contact_count[0])                                             <L 301>
        ...
        // shape_index = contact_shape[tid]                                                       <L 304>
        var_6 = wp::address(var_contact_shape, var_0);
        var_7 = wp::load(var_6);
        var_8 = wp::copy(var_7);
        // body_index = shape_body[shape_index]                                                   <L 305>
        var_9 = wp::address(var_shape_body, var_8);
        var_10 = wp::load(var_9);
        var_11 = wp::copy(var_10);
        // particle_index = contact_particle[tid]                                                 <L 306>
        var_12 = wp::address(var_contact_particle, var_0);
        var_13 = wp::load(var_12);
        var_14 = wp::copy(var_13);
        // if (particle_flags[particle_index] & PARTICLE_FLAG_ACTIVE) == 0:                       <L 307>
        ...
        // if c > particle_ka:                                                                    <L 320>
        var_50 = (var_49 > var_particle_ka);
        if (var_50) {
            // return                                                                             <L 321>
            return;
        }
        // mu = 0.5 * (particle_mu + shape_materials.mu[shape_index])                             <L 322>
        ...
        // body_v_s = wp.spatial_vector()                                                         <L 323>
        var_58 = wp::vec_t<6,wp::float32>();
        // if body_index >= 0:                                                                    <L 324>
        var_59 = (var_11 >= var_1);
        if (var_59) {
            // body_v_s = body_qd[body_index]                                                     <L 325>
            var_60 = wp::address(var_body_qd, var_11);
            var_61 = wp::load(var_60);
            var_62 = wp::copy(var_61);
        }
        var_63 = wp::select(var_59, var_58, var_62);
        // body_w = wp.spatial_top(body_v_s)                                                      <L 326>
        var_64 = wp::spatial_top(var_63);
        // body_v = wp.spatial_bottom(body_v_s)                                                   <L 327>
        var_65 = wp::spatial_bottom(var_63);
        // bv = body_v + wp.cross(body_w, r) + wp.transform_vector(X_wb, contact_body_vel[tid])       <L 328>
        ...
        var_90 = (var_11 >= var_1);
        if (var_90) {
            // angular = wp.cross(r, n)                                                           <L 339>
            var_91 = wp::cross(var_41, var_44);
            // q = wp.transform_get_rotation(X_wb)                                                <L 340>
            var_92 = wp::transform_get_rotation(var_35);
            // rot_angular = wp.quat_rotate_inv(q, angular)                                       <L 341>
            var_93 = wp::quat_rotate_inv(var_92, var_91);
            // I_inv = body_I_inv[body_index]                                                     <L 342>
            var_94 = wp::address(var_body_I_inv, var_11);
            var_95 = wp::load(var_94);
            var_96 = wp::copy(var_95);
            // w2 = body_m_inv[body_index] + wp.dot(rot_angular, I_inv * rot_angular)             <L 343>
        ...
        // lambda_f = wp.max(mu * lambda_n, -wp.length(vt) * dt)                                  <L 347>
        ...
        // delta_f = wp.normalize(vt) * lambda_f                                                  <L 348>
        var_110 = wp::normalize(var_77);
        var_111 = wp::mul(var_110, var_109);
        // delta_total = (delta_f - delta_n) / denom * relaxation * w1                            <L 349>
        ...
        // wp.atomic_add(delta, particle_index, delta_total)                                      <L 350>
        var_116 = wp::atomic_add(var_delta, var_14, var_115);
        // if body_index >= 0:                                                                    <L 351>
        var_117 = (var_11 >= var_1);
        if (var_117) {
            // delta_t = wp.cross(r, delta_total)                                                 <L 352>
            var_118 = wp::cross(var_41, var_115);
            // wp.atomic_sub(body_delta, body_index, wp.spatial_vector(delta_t, delta_total))       <L 353>
    ...
    wp::array_t<wp::vec_t<6,wp::float32>> adj_body_delta)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        if (var_117) {
            ...
            // adj: wp.atomic_sub(body_delta, body_index, wp.spatial_vector(delta_t, delta_total))  <L 353>
            wp::adj_cross(var_41, var_115, adj_41, adj_115, adj_118);
            // adj: delta_t = wp.cross(r, delta_total)                                            <L 352>
        }
        // adj: if body_index >= 0:                                                               <L 351>
        wp::adj_atomic_add(var_delta, var_14, var_115, adj_delta, adj_14, adj_115, adj_116);
        // adj: wp.atomic_add(delta, particle_index, delta_total)                                 <L 350>
        ...
        // adj: delta_total = (delta_f - delta_n) / denom * relaxation * w1                       <L 349>
        wp::adj_mul(var_110, var_109, adj_110, adj_109, adj_111);
        wp::adj_normalize(var_77, var_110, adj_77, adj_110);
        // adj: delta_f = wp.normalize(vt) * lambda_f                                             <L 348>
        ...
        // adj: lambda_f = wp.max(mu * lambda_n, -wp.length(vt) * dt)                             <L 347>
        if (var_104) {
            label3:;
            // adj: return                                                                        <L 346>
        }
        // adj: if denom == 0.0:                                                                  <L 345>
        wp::adj_add(var_84, var_102, adj_84, adj_102, adj_103);
        // adj: denom = w1 + w2                                                                   <L 344>
        ...
        if (var_90) {
            ...
            // adj: w2 = body_m_inv[body_index] + wp.dot(rot_angular, I_inv * rot_angular)        <L 343>
            ...
            // adj: I_inv = body_I_inv[body_index]                                                <L 342>
            wp::adj_quat_rotate_inv(var_92, var_91, adj_92, adj_91, adj_93);
            // adj: rot_angular = wp.quat_rotate_inv(q, angular)                                  <L 341>
            wp::adj_transform_get_rotation(var_35, adj_35, adj_92);
            // adj: q = wp.transform_get_rotation(X_wb)                                           <L 340>
            wp::adj_cross(var_41, var_44, adj_41, adj_44, adj_91);
            // adj: angular = wp.cross(r, n)                                                      <L 339>
        }
        ...
        // adj: w2 = particle_invmass[particle_index]*wp.float(0.0)                               <L 337>
        ...
        // adj: w1 = particle_invmass[particle_index]                                             <L 336>
        ...
        if (var_79) {
            ...
            // adj: mu=staticGroundFriction                                                       <L 335>
        }
        wp::adj_abs(var_75, adj_75, adj_78);
        // adj: if wp.abs(vn)<staticGroundVelocityThresholdRatio:                                 <L 334>
        ...
        // adj: bv = body_v + wp.cross(body_w, r) + wp.transform_vector(X_wb, contact_body_vel[tid])  <L 328>
        wp::adj_spatial_bottom(var_63, adj_63, adj_65);
        // adj: body_v = wp.spatial_bottom(body_v_s)                                              <L 327>
        wp::adj_spatial_top(var_63, adj_63, adj_64);
        // adj: body_w = wp.spatial_top(body_v_s)                                                 <L 326>
        ...
        if (var_59) {
            ...
            // adj: body_v_s = body_qd[body_index]                                                <L 325>
        }
        // adj: if body_index >= 0:                                                               <L 324>
        // adj: body_v_s = wp.spatial_vector()                                                    <L 323>
        ...
        // adj: mu = 0.5 * (particle_mu + shape_materials.mu[shape_index])                        <L 322>
        if (var_50) {
            label2:;
            // adj: return                                                                        <L 321>
        }
        // adj: if c > particle_ka:                                                               <L 320>
        ...
        // adj: c = wp.dot(n, px - bx) - particle_radius[particle_index]                          <L 319>
        ...
        // adj: bx = wp.transform_point(X_wb, contact_body_pos[tid])                              <L 316>
        ...
        if (var_28) {
            ...
            // adj: X_com = body_com[body_index]                                                  <L 315>
            ...
            // adj: X_wb = body_q[body_index]                                                     <L 314>
        }
        // adj: if body_index >= 0:                                                               <L 313>
        // adj: X_com = wp.vec3()                                                                 <L 312>
        // adj: X_wb = wp.transform_identity()                                                    <L 311>
        ...
        // adj: pv = particle_v[particle_index]                                                   <L 310>
        wp::adj_copy(var_21, adj_20, adj_22);
        wp::adj_load(var_20, adj_20, adj_21);
        wp::adj_address(var_particle_x, var_14, adj_particle_x, adj_14, adj_20);
        // adj: px = particle_x[particle_index]                                                   <L 309>
        if (var_19) {
            label1:;
            // adj: return                                                                        <L 308>
        }
        ...
        // adj: if (particle_flags[particle_index] & PARTICLE_FLAG_ACTIVE) == 0:                  <L 307>
        wp::adj_copy(var_13, adj_12, adj_14);
        wp::adj_load(var_12, adj_12, adj_13);
        wp::adj_address(var_contact_particle, var_0, adj_contact_particle, adj_0, adj_12);
        // adj: particle_index = contact_particle[tid]                                            <L 306>
        ...
        // adj: body_index = shape_body[shape_index]                                              <L 305>
        wp::adj_copy(var_7, adj_6, adj_8);
        wp::adj_load(var_6, adj_6, adj_7);
        wp::adj_address(var_contact_shape, var_0, adj_contact_shape, adj_0, adj_6);
        // adj: shape_index = contact_shape[tid]                                                  <L 304>
        if (var_5) {
            label0:;
            // adj: return                                                                        <L 303>
        }
        // adj: if tid >= count:                                                                  <L 302>
        ...
        // adj: count = min(contact_max, contact_count[0])                                        <L 301>
        // adj: tid = wp.tid()                                                                    <L 300>
        // adj: def my_solve_particle_shape_contacts(                                             <L 271>
        continue;
    }
}
    ...
    wp::float32 var_meshSidedFlag)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_create_soft_contacts(                                                           <L 356>
        // particle_index, shape_index = wp.tid()                                                 <L 374>
        builtin_tid2d(var_0, var_1);
        // if (particle_flags[particle_index] & PARTICLE_FLAG_ACTIVE) == 0:                       <L 375>
        var_2 = wp::address(var_particle_flags, var_0);
        var_4 = wp::load(var_2);
        ...
        // v = wp.vec3()                                                                          <L 391>
        var_41 = wp::vec_t<3,wp::float32>();
        // if geo_type == fs5Model.GEO_MESH:                                                      <L 392>
        var_43 = (var_33 == var_42);
        if (var_43) {
            // mesh = geo.source[shape_index]                                                     <L 393>
            var_44 = &(var_geo.source);
            var_45 = wp::load(var_44);
            var_46 = wp::address(var_45, var_1);
            var_47 = wp::load(var_46);
            var_48 = wp::copy(var_47);
            // face_index = int(0)                                                                <L 394>
            var_49 = wp::int(var_6);
            // face_u = float(0.0)                                                                <L 395>
            var_51 = wp::float(var_50);
            // face_v = float(0.0)                                                                <L 396>
            var_52 = wp::float(var_50);
            // sign = float(0.0)                                                                  <L 397>
            var_53 = wp::float(var_50);
            // if wp.mesh_query_point_sign_normal(                                                <L 398>
            // mesh, wp.cw_div(x_local, geo_scale), margin + radius, sign, face_index, face_u, face_v       <L 399>
            ...
            if (var_57) {
                // shape_p = wp.mesh_eval_position(mesh, face_index, face_u, face_v)              <L 401>
                var_58 = wp::mesh_eval_position(var_48, var_49, var_51, var_52);
                // shape_v = wp.mesh_eval_velocity(mesh, face_index, face_u, face_v)              <L 402>
                var_59 = wp::mesh_eval_velocity(var_48, var_49, var_51, var_52);
                // shape_p = wp.cw_mul(shape_p, geo_scale)                                        <L 403>
                var_60 = wp::cw_mul(var_58, var_38);
                // shape_v = wp.cw_mul(shape_v, geo_scale)                                        <L 404>
                var_61 = wp::cw_mul(var_59, var_38);
                // delta = x_local - shape_p                                                      <L 405>
                var_62 = wp::sub(var_28, var_60);
                // if meshSidedFlag == 0.0:                                                       <L 406>
                var_63 = (var_meshSidedFlag == var_50);
                if (var_63) {
                    // sign=1.0                                                                   <L 407>
                }
                var_65 = wp::select(var_63, var_53, var_64);
                // d = wp.length(delta) * sign                                                    <L 408>
                var_66 = wp::length(var_62);
                var_67 = wp::mul(var_66, var_65);
                // n = wp.normalize(delta) * sign                                                 <L 409>
    ...
    wp::float32 adj_meshSidedFlag)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        if (var_43) {
            ...
            // adj: mesh, wp.cw_div(x_local, geo_scale), margin + radius, sign, face_index, face_u, face_v  <L 399>
            // adj: if wp.mesh_query_point_sign_normal(                                           <L 398>
            wp::adj_float(var_50, adj_50, adj_53);
            // adj: sign = float(0.0)                                                             <L 397>
            wp::adj_float(var_50, adj_50, adj_52);
            // adj: face_v = float(0.0)                                                           <L 396>
            wp::adj_float(var_50, adj_50, adj_51);
            // adj: face_u = float(0.0)                                                           <L 395>
            wp::adj_int(var_6, adj_6, adj_49);
            // adj: face_index = int(0)                                                           <L 394>
            ...
            // adj: mesh = geo.source[shape_index]                                                <L 393>
        }
        // adj: if geo_type == fs5Model.GEO_MESH:                                                 <L 392>
        // adj: v = wp.vec3()                                                                     <L 391>
        // adj: n = wp.vec3()                                                                     <L 390>
        // adj: d = 1.0e6                                                                         <L 389>
        ...
        if (var_18) {
            ...
            // adj: X_wb = body_X_wb[rigid_index]                                                 <L 382>
        }
        // adj: if rigid_index >= 0:                                                              <L 381>
        // adj: X_wb = wp.transform_identity()                                                    <L 380>
        wp::adj_copy(var_15, adj_14, adj_16);
        wp::adj_load(var_14, adj_14, adj_15);
        wp::adj_address(var_particle_radius, var_0, adj_particle_radius, adj_0, adj_14);
        // adj: radius = particle_radius[particle_index]                                          <L 379>
        wp::adj_copy(var_12, adj_11, adj_13);
        wp::adj_load(var_11, adj_11, adj_12);
        wp::adj_address(var_particle_x, var_0, adj_particle_x, adj_0, adj_11);
        // adj: px = particle_x[particle_index]                                                   <L 378>
        ...
        // adj: rigid_index = shape_body[shape_index]                                             <L 377>
        if (var_7) {
            label0:;
            // adj: return                                                                        <L 376>
        }
        ...
        wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_2);
        // adj: if (particle_flags[particle_index] & PARTICLE_FLAG_ACTIVE) == 0:                  <L 375>
        // adj: particle_index, shape_index = wp.tid()                                            <L 374>
        // adj: def my_create_soft_contacts(                                                      <L 356>
        continue;
    }
}
