    ...
    wp::float32 var_swellingActivationLocationRatio)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        wp::float32* var_94;
        wp::uint32 var_95;
        const wp::float32 var_96 = 10000.0;
        wp::float32 var_97;
        wp::float32 var_98;
        const wp::float32 var_99 = 25.0;
        wp::float32 var_100;
        //---------
        // forward
            ...
            if (var_19) {
                ...
                if (var_22) {
                    ...
                    if (var_34) {
                        ...
                        // particle_inv_mass[trackedID]=mass*10000.0                              <L 88>
                        var_97 = wp::mul(var_37, var_96);
                        wp::array_store(var_particle_inv_mass, var_14, var_97);
                        // particle_radius[trackedID]=radius/swelling_rotation_max/25.0           <L 89>
                        var_98 = wp::div(var_40, var_swelling_rotation_max);
                        var_100 = wp::div(var_98, var_99);
                        wp::array_store(var_particle_radius, var_14, var_100);
                    }
                }
            }
        }
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        if (var_13) {
            if (var_19) {
                if (var_22) {
                    if (var_34) {
                        wp::adj_array_store(var_particle_radius, var_14, var_100, adj_particle_radius, adj_14, adj_100);
                        wp::adj_div(var_98, var_99, var_100, adj_98, adj_99, adj_100);
                        wp::adj_div(var_40, var_swelling_rotation_max, var_98, adj_40, adj_swelling_rotation_max, adj_98);
                        // adj: particle_radius[trackedID]=radius/swelling_rotation_max/25.0      <L 89>
                        wp::adj_array_store(var_particle_inv_mass, var_14, var_97, adj_particle_inv_mass, adj_14, adj_97);
                        wp::adj_mul(var_37, var_96, adj_37, adj_96, adj_97);
                        // adj: particle_inv_mass[trackedID]=mass*10000.0                         <L 88>
    ...
    wp::float32 var_fullRadius)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        wp::float32 var_22;
        wp::float32 var_23;
        const wp::float32 var_24 = 10000.0;
        bool var_25;
        bool var_26;
        wp::float32* var_27;
        wp::float32 var_28;
        ...
        // if particle_flags[tid]==wp.uint32(1) and 1.0/particle_inv_mass[tid]<10000.0:           <L 104>
        var_16 = wp::address(var_particle_flags, var_0);
        var_17 = wp::uint32(var_2);
        ...
        if (var_26) {
            // particle_inv_mass[tid]=1.0/((1.0/(particle_inv_mass[tid]))+10000.0/swelling_rotation_max/25.0)       <L 105>
            var_27 = wp::address(var_particle_inv_mass, var_0);
            var_28 = wp::load(var_27);
            var_29 = wp::div(var_20, var_28);
            var_30 = wp::div(var_24, var_swelling_rotation_max);
            var_31 = wp::div(var_30, var_12);
            var_32 = wp::add(var_29, var_31);
            var_33 = wp::div(var_20, var_32);
            wp::array_store(var_particle_inv_mass, var_0, var_33);
        }
    }
}
    ...
    wp::float32 adj_fullRadius)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // reverse
        if (var_26) {
            wp::adj_array_store(var_particle_inv_mass, var_0, var_33, adj_particle_inv_mass, adj_0, adj_33);
            wp::adj_div(var_20, var_32, var_33, adj_20, adj_32, adj_33);
            wp::adj_add(var_29, var_31, adj_29, adj_31, adj_32);
            wp::adj_div(var_30, var_12, var_31, adj_30, adj_12, adj_31);
            wp::adj_div(var_24, var_swelling_rotation_max, var_30, adj_24, adj_swelling_rotation_max, adj_30);
            wp::adj_div(var_20, var_28, var_29, adj_20, adj_27, adj_29);
            wp::adj_load(var_27, adj_27, adj_28);
            wp::adj_address(var_particle_inv_mass, var_0, adj_particle_inv_mass, adj_0, adj_27);
            // adj: particle_inv_mass[tid]=1.0/((1.0/(particle_inv_mass[tid]))+10000.0/swelling_rotation_max/25.0)  <L 105>
        }
        wp::adj_div(var_20, var_22, var_23, adj_20, adj_21, adj_23);
        wp::adj_load(var_21, adj_21, adj_22);
        wp::adj_address(var_particle_inv_mass, var_0, adj_particle_inv_mass, adj_0, adj_21);
        wp::adj_load(var_16, adj_16, adj_19);
        wp::adj_uint32(var_2, adj_2, adj_17);
        wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_16);
        // adj: if particle_flags[tid]==wp.uint32(1) and 1.0/particle_inv_mass[tid]<10000.0:      <L 104>
        if (var_9) {
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> var_v_new)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_integrate_particles(                                                            <L 109>
        // tid = wp.tid()                                                                         <L 121>
        var_0 = builtin_tid1d();
        // if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                                  <L 122>
        var_1 = wp::address(var_particle_flags, var_0);
        var_3 = wp::load(var_1);
        var_4 = wp::bit_and(var_3, var_2);
        var_6 = (var_4 == var_5);
        ...
        // inv_mass = w[tid]                                                                      <L 127>
        var_16 = wp::address(var_w, var_0);
        var_17 = wp::load(var_16);
        var_18 = wp::copy(var_17);
        // v1 = v0 + (f0 * inv_mass + gravity * wp.step(0.0 - inv_mass)) * dt                     <L 128>
        ...
        // v1_mag = wp.length(v1)                                                                 <L 129>
        var_27 = wp::length(var_26);
        // if v1_mag > v_max:                                                                     <L 130>
        var_28 = (var_27 > var_v_max);
        if (var_28) {
            // v1 *= v_max / v1_mag                                                               <L 131>
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> adj_v_new)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        if (var_28) {
            ...
            // adj: v1 *= v_max / v1_mag                                                          <L 131>
        }
        // adj: if v1_mag > v_max:                                                                <L 130>
        wp::adj_length(var_26, var_27, adj_26, adj_27);
        // adj: v1_mag = wp.length(v1)                                                            <L 129>
        ...
        // adj: v1 = v0 + (f0 * inv_mass + gravity * wp.step(0.0 - inv_mass)) * dt                <L 128>
        wp::adj_copy(var_17, adj_16, adj_18);
        wp::adj_load(var_16, adj_16, adj_17);
        wp::adj_address(var_w, var_0, adj_w, adj_0, adj_16);
        // adj: inv_mass = w[tid]                                                                 <L 127>
        ...
        wp::adj_load(var_1, adj_1, adj_3);
        wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_1);
        // adj: if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                             <L 122>
        // adj: tid = wp.tid()                                                                    <L 121>
        // adj: def my_integrate_particles(                                                       <L 109>
        continue;
    }
}
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> var_v_out)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_apply_particle_deltas(                                                          <L 137>
        // tid = wp.tid()                                                                         <L 147>
        var_0 = builtin_tid1d();
        // if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                                  <L 148>
        var_1 = wp::address(var_particle_flags, var_0);
        var_3 = wp::load(var_1);
        var_4 = wp::bit_and(var_3, var_2);
        var_6 = (var_4 == var_5);
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> adj_v_out)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        wp::adj_load(var_1, adj_1, adj_3);
        wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_1);
        // adj: if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                             <L 148>
        // adj: tid = wp.tid()                                                                    <L 147>
        // adj: def my_apply_particle_deltas(                                                     <L 137>
        continue;
    }
}
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> var_delta)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_solve_particle_ground_contacts(                                                 <L 167>
        // tid = wp.tid()                                                                         <L 184>
        var_0 = builtin_tid1d();
        // if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                                  <L 185>
        var_1 = wp::address(var_particle_flags, var_0);
        var_3 = wp::load(var_1);
        var_4 = wp::bit_and(var_3, var_2);
        var_6 = (var_4 == var_5);
        ...
        // c = wp.min(wp.dot(n, x) + ground[3] - particle_radius[tid], 0.0)                       <L 194>
        ...
        // lambda_f = wp.max(mu * lambda_n, 0.0 - wp.length(vt) * dt)                             <L 203>
        ...
        // delta_f = wp.normalize(vt) * lambda_f                                                  <L 204>
        var_54 = wp::normalize(var_48);
        var_55 = wp::mul(var_54, var_53);
        // wp.atomic_add(delta, tid, (delta_f - delta_n) / wi * relaxation * wi)                  <L 205>
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> adj_delta)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // adj: wp.atomic_add(delta, tid, (delta_f - delta_n) / wi * relaxation * wi)             <L 205>
        wp::adj_mul(var_54, var_53, adj_54, adj_53, adj_55);
        wp::adj_normalize(var_48, var_54, adj_48, adj_54);
        // adj: delta_f = wp.normalize(vt) * lambda_f                                             <L 204>
        ...
        // adj: lambda_f = wp.max(mu * lambda_n, 0.0 - wp.length(vt) * dt)                        <L 203>
        ...
        if (var_44) {
            ...
            // adj: mu=staticGroundFriction                                                       <L 201>
        }
        wp::adj_abs(var_42, adj_42, adj_43);
        // adj: if wp.abs(vn)<staticGroundVelocityThresholdRatio:                                 <L 200>
        wp::adj_dot(var_29, var_20, adj_29, adj_20, adj_42);
        // adj: vn = wp.dot(n, v)                                                                 <L 199>
        wp::adj_mul(var_29, var_40, adj_29, adj_40, adj_41);
        // adj: delta_n = n * lambda_n                                                            <L 198>
        wp::adj_copy(var_38, adj_38, adj_40);
        // adj: lambda_n = c                                                                      <L 197>
        if (var_39) {
            label2:;
            // adj: return                                                                        <L 196>
        }
        ...
        // adj: c = wp.min(wp.dot(n, x) + ground[3] - particle_radius[tid], 0.0)                  <L 194>
        ...
        // adj: n = wp.vec3(ground[0], ground[1], ground[2])                                      <L 193>
        ...
        // adj: radius = particle_radius[tid]                                                     <L 190>
        if (var_11) {
            label1:;
            // adj: return                                                                        <L 189>
        }
        ...
        wp::adj_load(var_1, adj_1, adj_3);
        wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_1);
        // adj: if (particle_flags[tid] & PARTICLE_FLAG_ACTIVE) == 0:                             <L 185>
        // adj: tid = wp.tid()                                                                    <L 184>
        // adj: def my_solve_particle_ground_contacts(                                            <L 167>
        continue;
    }
}
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> var_deltas)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_solve_particle_particle_contacts(                                               <L 208>
        // tid = wp.tid()                                                                         <L 224>
        var_0 = builtin_tid1d();
        // i = wp.hash_grid_point_id(grid, tid)                                                   <L 225>
        ...
        // if (particle_flags[i] & PARTICLE_FLAG_ACTIVE) == 0:                                    <L 228>
        ...
        if ((var_29) == false) goto end_while_2;
            ...
            if (var_35) {
                ...
                if (var_50) {
                    ...
                    // lambda_f = wp.max(k_mu * lambda_n, -wp.length(vt) * dt)                    <L 253>
                    ...
                    // delta_f = wp.normalize(vt) * lambda_f                                      <L 254>
                    var_69 = wp::normalize(var_63);
                    var_70 = wp::mul(var_69, var_68);
                    // delta += (delta_f - delta_n) / denom * w1                                  <L 255>
        ...
        goto start_while_2;
        end_while_2:;
        // wp.atomic_add(deltas, i, delta * relaxation)                                           <L 256>
    ...
    wp::array_t<wp::vec_t<3,wp::float32>> adj_deltas)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // adj: wp.atomic_add(deltas, i, delta * relaxation)                                      <L 256>
        start_while_2:;
        var_29 = wp::hash_grid_query_next(var_25, var_26);
        if ((var_29) == false) goto end_while_2;
        adj_30 = {};
        ...
        adj_79 = {};
            ...
            if (var_35) {
                ...
                if (var_50) {
                    ...
                    // adj: lambda_f = wp.max(k_mu * lambda_n, -wp.length(vt) * dt)               <L 253>
                    ...
                    if (var_59) {
                        ...
                        // adj: k_mu=staticParticleFriction                                       <L 251>
                    }
                    wp::adj_abs(var_57, adj_57, adj_58);
                    // adj: if wp.abs(vn)<staticParticleVelocityThresholdRatio:                   <L 250>
                    wp::adj_dot(var_51, var_54, adj_51, adj_54, adj_57);
                    // adj: vn = wp.dot(n, vrel)                                                  <L 249>
                    wp::adj_mul(var_51, var_55, adj_51, adj_55, adj_56);
                    // adj: delta_n = n * lambda_n                                                <L 248>
                    wp::adj_copy(var_43, adj_43, adj_55);
                    // adj: lambda_n = err                                                        <L 247>
                    ...
                    // adj: vrel = v - particle_v[index]                                          <L 246>
                    wp::adj_div(var_38, var_39, adj_38, adj_39, adj_51);
                    // adj: n = n / d                                                             <L 245>
                }
                // adj: if err <= k_cohesion and denom > 0.0:                                     <L 244>
                wp::adj_add(var_22, var_46, adj_22, adj_46, adj_47);
                // adj: denom = w1 + w2                                                           <L 243>
                ...
                // adj: w2 = particle_invmass[index]                                              <L 242>
                ...
                // adj: err = d - radius - particle_radius[index]                                 <L 241>
                wp::adj_length(var_38, var_39, adj_38, adj_39);
                // adj: d = wp.length(n)                                                          <L 240>
                ...
                // adj: n = x - particle_x[index]                                                 <L 239>
            }
            ...
            // adj: if (particle_flags[index] & PARTICLE_FLAG_ACTIVE) != 0 and index != i:        <L 238>
        goto start_while_2;
        end_while_2:;
        // adj: while wp.hash_grid_query_next(query, index):                                      <L 237>
        wp::adj_vec_t(var_27, adj_27, adj_28);
        // adj: delta = wp.vec3(0.0)                                                              <L 236>
        wp::adj_int(var_9, adj_9, adj_26);
        // adj: index = int(0)                                                                    <L 235>
        ...
        // adj: query = wp.hash_grid_query(grid, x, radius + max_radius + k_cohesion)             <L 234>
        ...
        // adj: w1 = particle_invmass[i]                                                          <L 233>
        ...
        // adj: radius = particle_radius[i]                                                       <L 232>
        ...
        // adj: if (particle_flags[i] & PARTICLE_FLAG_ACTIVE) == 0:                               <L 228>
        if (var_4) {
            label0:;
            // adj: return                                                                        <L 227>
        }
        ...
        // adj: i = wp.hash_grid_point_id(grid, tid)                                              <L 225>
        // adj: tid = wp.tid()                                                                    <L 224>
        // adj: def my_solve_particle_particle_contacts(                                          <L 208>
        continue;
    }
}
    ...
    wp::array_t<wp::vec_t<6,wp::float32>> var_body_delta)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_solve_particle_shape_contacts(                                                  <L 259>
        // tid = wp.tid()                                                                         <L 288>
        var_0 = builtin_tid1d();
        // count = min(contact_max, contact_count[0])                                             <L 289>
        ...
        // shape_index = contact_shape[tid]                                                       <L 292>
        var_6 = wp::address(var_contact_shape, var_0);
        var_7 = wp::load(var_6);
        var_8 = wp::copy(var_7);
        // body_index = shape_body[shape_index]                                                   <L 293>
        var_9 = wp::address(var_shape_body, var_8);
        var_10 = wp::load(var_9);
        var_11 = wp::copy(var_10);
        // particle_index = contact_particle[tid]                                                 <L 294>
        var_12 = wp::address(var_contact_particle, var_0);
        var_13 = wp::load(var_12);
        var_14 = wp::copy(var_13);
        // if (particle_flags[particle_index] & PARTICLE_FLAG_ACTIVE) == 0:                       <L 295>
        ...
        // if c > particle_ka:                                                                    <L 308>
        var_50 = (var_49 > var_particle_ka);
        if (var_50) {
            // return                                                                             <L 309>
            return;
        }
        // mu = 0.5 * (particle_mu + shape_materials.mu[shape_index])                             <L 310>
        ...
        // body_v_s = wp.spatial_vector()                                                         <L 311>
        var_58 = wp::vec_t<6,wp::float32>();
        // if body_index >= 0:                                                                    <L 312>
        var_59 = (var_11 >= var_1);
        if (var_59) {
            // body_v_s = body_qd[body_index]                                                     <L 313>
            var_60 = wp::address(var_body_qd, var_11);
            var_61 = wp::load(var_60);
            var_62 = wp::copy(var_61);
        }
        var_63 = wp::select(var_59, var_58, var_62);
        // body_w = wp.spatial_top(body_v_s)                                                      <L 314>
        var_64 = wp::spatial_top(var_63);
        // body_v = wp.spatial_bottom(body_v_s)                                                   <L 315>
        var_65 = wp::spatial_bottom(var_63);
        // bv = body_v + wp.cross(body_w, r) + wp.transform_vector(X_wb, contact_body_vel[tid])       <L 316>
        ...
        // lambda_f = wp.max(mu * lambda_n, -wp.length(vt) * dt)                                  <L 335>
        ...
        // delta_f = wp.normalize(vt) * lambda_f                                                  <L 336>
        var_110 = wp::normalize(var_77);
        var_111 = wp::mul(var_110, var_109);
        // delta_total = (delta_f - delta_n) / denom * relaxation * w1                            <L 337>
        ...
        // wp.atomic_add(delta, particle_index, delta_total)                                      <L 338>
        var_116 = wp::atomic_add(var_delta, var_14, var_115);
        // if body_index >= 0:                                                                    <L 339>
        var_117 = (var_11 >= var_1);
        if (var_117) {
            // delta_t = wp.cross(r, delta_total)                                                 <L 340>
            var_118 = wp::cross(var_41, var_115);
            // wp.atomic_sub(body_delta, body_index, wp.spatial_vector(delta_t, delta_total))       <L 341>
    ...
    wp::array_t<wp::vec_t<6,wp::float32>> adj_body_delta)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        if (var_117) {
            ...
            // adj: wp.atomic_sub(body_delta, body_index, wp.spatial_vector(delta_t, delta_total))  <L 341>
            wp::adj_cross(var_41, var_115, adj_41, adj_115, adj_118);
            // adj: delta_t = wp.cross(r, delta_total)                                            <L 340>
        }
        // adj: if body_index >= 0:                                                               <L 339>
        wp::adj_atomic_add(var_delta, var_14, var_115, adj_delta, adj_14, adj_115, adj_116);
        // adj: wp.atomic_add(delta, particle_index, delta_total)                                 <L 338>
        ...
        // adj: delta_total = (delta_f - delta_n) / denom * relaxation * w1                       <L 337>
        wp::adj_mul(var_110, var_109, adj_110, adj_109, adj_111);
        wp::adj_normalize(var_77, var_110, adj_77, adj_110);
        // adj: delta_f = wp.normalize(vt) * lambda_f                                             <L 336>
        ...
        // adj: lambda_f = wp.max(mu * lambda_n, -wp.length(vt) * dt)                             <L 335>
        if (var_104) {
            label3:;
            // adj: return                                                                        <L 334>
        }
        // adj: if denom == 0.0:                                                                  <L 333>
        wp::adj_add(var_84, var_102, adj_84, adj_102, adj_103);
        // adj: denom = w1 + w2                                                                   <L 332>
        ...
        if (var_90) {
            ...
            // adj: w2 = body_m_inv[body_index] + wp.dot(rot_angular, I_inv * rot_angular)        <L 331>
            ...
            // adj: I_inv = body_I_inv[body_index]                                                <L 330>
            wp::adj_quat_rotate_inv(var_92, var_91, adj_92, adj_91, adj_93);
            // adj: rot_angular = wp.quat_rotate_inv(q, angular)                                  <L 329>
            wp::adj_transform_get_rotation(var_35, adj_35, adj_92);
            // adj: q = wp.transform_get_rotation(X_wb)                                           <L 328>
            wp::adj_cross(var_41, var_44, adj_41, adj_44, adj_91);
            // adj: angular = wp.cross(r, n)                                                      <L 327>
        }
        // adj: if body_index >= 0:                                                               <L 326>
        ...
        // adj: w2 = particle_invmass[particle_index]*wp.float(0.0)                               <L 325>
        ...
        // adj: w1 = particle_invmass[particle_index]                                             <L 324>
        ...
        if (var_79) {
            ...
            // adj: mu=staticGroundFriction                                                       <L 323>
        }
        wp::adj_abs(var_75, adj_75, adj_78);
        // adj: if wp.abs(vn)<staticGroundVelocityThresholdRatio:                                 <L 322>
        ...
        // adj: bv = body_v + wp.cross(body_w, r) + wp.transform_vector(X_wb, contact_body_vel[tid])  <L 316>
        wp::adj_spatial_bottom(var_63, adj_63, adj_65);
        // adj: body_v = wp.spatial_bottom(body_v_s)                                              <L 315>
        wp::adj_spatial_top(var_63, adj_63, adj_64);
        // adj: body_w = wp.spatial_top(body_v_s)                                                 <L 314>
        ...
        if (var_59) {
            ...
            // adj: body_v_s = body_qd[body_index]                                                <L 313>
        }
        // adj: if body_index >= 0:                                                               <L 312>
        // adj: body_v_s = wp.spatial_vector()                                                    <L 311>
        ...
        // adj: mu = 0.5 * (particle_mu + shape_materials.mu[shape_index])                        <L 310>
        if (var_50) {
            label2:;
            // adj: return                                                                        <L 309>
        }
        // adj: if c > particle_ka:                                                               <L 308>
        ...
        // adj: c = wp.dot(n, px - bx) - particle_radius[particle_index]                          <L 307>
        ...
        // adj: bx = wp.transform_point(X_wb, contact_body_pos[tid])                              <L 304>
        ...
        if (var_28) {
            ...
            // adj: X_com = body_com[body_index]                                                  <L 303>
            ...
            // adj: X_wb = body_q[body_index]                                                     <L 302>
        }
        // adj: if body_index >= 0:                                                               <L 301>
        // adj: X_com = wp.vec3()                                                                 <L 300>
        // adj: X_wb = wp.transform_identity()                                                    <L 299>
        ...
        // adj: pv = particle_v[particle_index]                                                   <L 298>
        wp::adj_copy(var_21, adj_20, adj_22);
        wp::adj_load(var_20, adj_20, adj_21);
        wp::adj_address(var_particle_x, var_14, adj_particle_x, adj_14, adj_20);
        // adj: px = particle_x[particle_index]                                                   <L 297>
        if (var_19) {
            label1:;
            // adj: return                                                                        <L 296>
        }
        ...
        // adj: if (particle_flags[particle_index] & PARTICLE_FLAG_ACTIVE) == 0:                  <L 295>
        wp::adj_copy(var_13, adj_12, adj_14);
        wp::adj_load(var_12, adj_12, adj_13);
        wp::adj_address(var_contact_particle, var_0, adj_contact_particle, adj_0, adj_12);
        // adj: particle_index = contact_particle[tid]                                            <L 294>
        ...
        // adj: body_index = shape_body[shape_index]                                              <L 293>
        ...
        // adj: shape_index = contact_shape[tid]                                                  <L 292>
        if (var_5) {
            label0:;
            // adj: return                                                                        <L 291>
        }
        // adj: if tid >= count:                                                                  <L 290>
        ...
        // adj: count = min(contact_max, contact_count[0])                                        <L 289>
        // adj: tid = wp.tid()                                                                    <L 288>
        // adj: def my_solve_particle_shape_contacts(                                             <L 259>
        continue;
    }
}
    ...
    wp::float32 var_meshSidedFlag)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def my_create_soft_contacts(                                                           <L 344>
        // particle_index, shape_index = wp.tid()                                                 <L 362>
        builtin_tid2d(var_0, var_1);
        // if (particle_flags[particle_index] & PARTICLE_FLAG_ACTIVE) == 0:                       <L 363>
        var_2 = wp::address(var_particle_flags, var_0);
        var_4 = wp::load(var_2);
        ...
        // v = wp.vec3()                                                                          <L 379>
        var_41 = wp::vec_t<3,wp::float32>();
        // if geo_type == fs5Model.GEO_MESH:                                                      <L 380>
        var_43 = (var_33 == var_42);
        if (var_43) {
            // mesh = geo.source[shape_index]                                                     <L 381>
            var_44 = &(var_geo.source);
            var_45 = wp::load(var_44);
            var_46 = wp::address(var_45, var_1);
            var_47 = wp::load(var_46);
            var_48 = wp::copy(var_47);
            // face_index = int(0)                                                                <L 382>
            var_49 = wp::int(var_6);
            // face_u = float(0.0)                                                                <L 383>
            var_51 = wp::float(var_50);
            // face_v = float(0.0)                                                                <L 384>
            var_52 = wp::float(var_50);
            // sign = float(0.0)                                                                  <L 385>
            var_53 = wp::float(var_50);
            // if wp.mesh_query_point_sign_normal(                                                <L 386>
            // mesh, wp.cw_div(x_local, geo_scale), margin + radius, sign, face_index, face_u, face_v       <L 387>
            ...
            if (var_57) {
                // shape_p = wp.mesh_eval_position(mesh, face_index, face_u, face_v)              <L 389>
                var_58 = wp::mesh_eval_position(var_48, var_49, var_51, var_52);
                // shape_v = wp.mesh_eval_velocity(mesh, face_index, face_u, face_v)              <L 390>
                var_59 = wp::mesh_eval_velocity(var_48, var_49, var_51, var_52);
                // shape_p = wp.cw_mul(shape_p, geo_scale)                                        <L 391>
                var_60 = wp::cw_mul(var_58, var_38);
                // shape_v = wp.cw_mul(shape_v, geo_scale)                                        <L 392>
                var_61 = wp::cw_mul(var_59, var_38);
                // delta = x_local - shape_p                                                      <L 393>
                var_62 = wp::sub(var_28, var_60);
                // if meshSidedFlag == 0.0:                                                       <L 394>
                var_63 = (var_meshSidedFlag == var_50);
                if (var_63) {
                    // sign=1.0                                                                   <L 395>
                }
                var_65 = wp::select(var_63, var_53, var_64);
                // d = wp.length(delta) * sign                                                    <L 396>
                var_66 = wp::length(var_62);
                var_67 = wp::mul(var_66, var_65);
                // n = wp.normalize(delta) * sign                                                 <L 397>
    ...
    wp::float32 adj_meshSidedFlag)
{
         ...
         task_index += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        if (var_43) {
            ...
            // adj: mesh, wp.cw_div(x_local, geo_scale), margin + radius, sign, face_index, face_u, face_v  <L 387>
            // adj: if wp.mesh_query_point_sign_normal(                                           <L 386>
            wp::adj_float(var_50, adj_50, adj_53);
            // adj: sign = float(0.0)                                                             <L 385>
            wp::adj_float(var_50, adj_50, adj_52);
            // adj: face_v = float(0.0)                                                           <L 384>
            wp::adj_float(var_50, adj_50, adj_51);
            // adj: face_u = float(0.0)                                                           <L 383>
            wp::adj_int(var_6, adj_6, adj_49);
            // adj: face_index = int(0)                                                           <L 382>
            ...
            // adj: mesh = geo.source[shape_index]                                                <L 381>
        }
        // adj: if geo_type == fs5Model.GEO_MESH:                                                 <L 380>
        // adj: v = wp.vec3()                                                                     <L 379>
        // adj: n = wp.vec3()                                                                     <L 378>
        // adj: d = 1.0e6                                                                         <L 377>
        ...
        if (var_18) {
            ...
            // adj: X_wb = body_X_wb[rigid_index]                                                 <L 370>
        }
        // adj: if rigid_index >= 0:                                                              <L 369>
        // adj: X_wb = wp.transform_identity()                                                    <L 368>
        wp::adj_copy(var_15, adj_14, adj_16);
        wp::adj_load(var_14, adj_14, adj_15);
        wp::adj_address(var_particle_radius, var_0, adj_particle_radius, adj_0, adj_14);
        // adj: radius = particle_radius[particle_index]                                          <L 367>
        wp::adj_copy(var_12, adj_11, adj_13);
        wp::adj_load(var_11, adj_11, adj_12);
        wp::adj_address(var_particle_x, var_0, adj_particle_x, adj_0, adj_11);
        // adj: px = particle_x[particle_index]                                                   <L 366>
        ...
        // adj: rigid_index = shape_body[shape_index]                                             <L 365>
        if (var_7) {
            label0:;
            // adj: return                                                                        <L 364>
        }
        ...
        wp::adj_address(var_particle_flags, var_0, adj_particle_flags, adj_0, adj_2);
        // adj: if (particle_flags[particle_index] & PARTICLE_FLAG_ACTIVE) == 0:                  <L 363>
        // adj: particle_index, shape_index = wp.tid()                                            <L 362>
        // adj: def my_create_soft_contacts(                                                      <L 344>
        continue;
    }
}
